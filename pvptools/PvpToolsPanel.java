...
class PvpToolsPanel extends PluginPanel
{
	...
	final JButton autoSpecBtn = new JButton("Auto Spec Enemy");
	final JButton autoHealBtn = new JButton("Triple Eat");
	...
	void init()
	{
		...
		riskPanel.add(autoSpecBtn);
		riskPanel.add(autoHealBtn);
